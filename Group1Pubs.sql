...
INSERT INTO EMPLOYMENT (jobID, job_lvl, pubID, positionStartDate, SSN, empID) VALUES
	(2, 215, (SELECT pubID FROM JOB WHERE jobID = 2), '11/11/89', '111111111', 'PTC11962M'),
	(3, 200, (SELECT pubID FROM JOB WHERE jobID = 3), '07/16/91', '111111112', 'AMD15433F'),
	(4, 227, (SELECT pubID FROM JOB WHERE jobID = 4), '11/03/90', '111111113', 'F-C16315M'),
	(5, 175, (SELECT pubID FROM JOB WHERE jobID = 5), '06/03/90', '111111114', 'LAL21447M'),
	(5, 159, (SELECT pubID FROM JOB WHERE jobID = 5), '08/19/93', '111111115', 'PXH22250M'),
	(5, 150, (SELECT pubID FROM JOB WHERE jobID = 5), '04/05/91', '111111116', 'SKO22412M'),
	(5, 198, (SELECT pubID FROM JOB WHERE jobID = 5), '10/09/93', '111111117', 'RBM23061F'),
	(5, 246, (SELECT pubID FROM JOB WHERE jobID = 5), '03/01/89', '111111118', 'MJP25939M'),
	(5, 172, (SELECT pubID FROM JOB WHERE jobID = 5), '05/26/91', '111111119', 'JYL26161F'),
	(5, 211, (SELECT pubID FROM JOB WHERE jobID = 5), '04/21/89', '111111110', 'CFH28514M'),
	(6, 140, (SELECT pubID FROM JOB WHERE jobID = 6), '09/13/90', '111111121', 'VPA30890F'),
	(7, 120, (SELECT pubID FROM JOB WHERE jobID = 7), '02/13/91', '111111131', 'L-B31947F'),
	(8, 100, (SELECT pubID FROM JOB WHERE jobID = 8), '01/27/93', '111111141', 'ARD36773F'),
	(9, 75,  (SELECT pubID FROM JOB WHERE jobID = 9), '02/05/92', '111111151', 'M-R38834F'),
	(10, 75, (SELECT pubID FROM JOB WHERE jobID = 10), '05/17/92','111111161', 'PHF38899M'),
	(11, 75, (SELECT pubID FROM JOB WHERE jobID = 11), '01/01/90','111111171', 'DBT39435M'),
	(12, 35, (SELECT pubID FROM JOB WHERE jobID = 12), '09/21/89','111111181', 'H-B39728F'),
	(13, 35, (SELECT pubID FROM JOB WHERE jobID = 13), '08/27/92','111111191', 'PMA42628M'),
	(14, 35, (SELECT pubID FROM JOB WHERE jobID = 14), '07/24/90','111111101', 'ENL44273F'),
	(6, 220, (SELECT pubID FROM JOB WHERE jobID = 6), '05/01/94', '111111211', 'MGK44605M'),
	(7, 195, (SELECT pubID FROM JOB WHERE jobID = 7), '05/09/93', '111111311', 'PDI47470M'),
	(8, 175, (SELECT pubID FROM JOB WHERE jobID = 8), '06/29/93', '111111411', 'MMS49649F'),
	(9, 170, (SELECT pubID FROM JOB WHERE jobID = 9), '08/09/88', '111111511', 'GHT50241M'),
	(10, 165, (SELECT pubID FROM JOB WHERE jobID = 10),'04/13/90','111111611', 'MFS52347M'),
	(11, 150, (SELECT pubID FROM JOB WHERE jobID = 11),'09/05/91','111111711', 'R-M53550M'),
	(12, 100, (SELECT pubID FROM JOB WHERE jobID = 12),'11/19/88','111111811', 'HAS54740M'),
	(13, 100, (SELECT pubID FROM JOB WHERE jobID = 13),'06/19/88','111111911', 'TPO55093M'),
	(14, 100, (SELECT pubID FROM JOB WHERE jobID = 14),'10/17/92','111111011', 'KFJ64308F'),
	(6, 192, (SELECT pubID FROM JOB WHERE jobID = 6), '12/16/91', '111112111', 'DWR65030M'),
	(7, 135, (SELECT pubID FROM JOB WHERE jobID = 7), '03/27/92', '111113111', 'M-L67958F'),
	(8, 125, (SELECT pubID FROM JOB WHERE jobID = 8), '01/19/94', '111114111', 'PSP68661F'),
	(9, 78, (SELECT pubID FROM JOB WHERE jobID = 9), '09/29/88',  '111115111', 'MAS70474F'),
	(10, 87, (SELECT pubID FROM JOB WHERE jobID = 10), '10/26/91','111116111', 'A-C71970F'),
	(11, 112, (SELECT pubID FROM JOB WHERE jobID = 11),'12/07/92','111117111', 'MAP77183M'),
	(12, 32, (SELECT pubID FROM JOB WHERE jobID = 12), '06/11/89','111118111', 'Y-L77953M'),
	(13, 64, (SELECT pubID FROM JOB WHERE jobID = 13),'07/07/92', '111119111', 'CGS88322F'),
	(14, 89, (SELECT pubID FROM JOB WHERE jobID = 14),'12/24/90', '111110111', 'PSA89086M'),
	(6, 152, (SELECT pubID FROM JOB WHERE jobID = 6), '02/21/90', '111121111', 'A-R89858F'),
	(7, 120, (SELECT pubID FROM JOB WHERE jobID = 7), '03/19/93', '111131111', 'HAN90777M'),
	(8, 101, (SELECT pubID FROM JOB WHERE jobID = 8), '01/09/89', '111141111', 'M-P91209M'),
	(9, 170, (SELECT pubID FROM JOB WHERE jobID = 9), '03/11/94', '111151111', 'KJJ92907F'),
	(10, 80, (SELECT pubID FROM JOB WHERE jobID = 10),'11/29/93', '111161111', 'POK93028M'),
	(11, 150, (SELECT pubID FROM JOB WHERE jobID = 11),'08/01/89','111171111', 'PCM98509F')
GO
